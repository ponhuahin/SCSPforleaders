...
/**
 * Created by User-Gamer on 3/29/2017.
 */

public class ListView_Work extends BaseAdapter {
    private static Activity activity;
    private static LayoutInflater inflater;
    ArrayList<Work_ToList> myToList;

    public ListView_Work(Activity activity, ArrayList<Work_ToList> mtToList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView;
        v = inflater.inflate(R.layout.listview_work, null);
